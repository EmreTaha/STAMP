...
class dep_SiamMaskedAutoencoderViT3D(nn.Module):
    ...
    def __init__(self, img_size=(224,224,32), patch_size=(16,16,16), in_chans=3,
        ...
        self.decoder_time_embed = TimestepEmbedder(decoder_embed_dim, 64, 160)
    ...
    def forward_encoder(self, x, x_future, mask_ratio, delta_t):
        ...
        #x = x + self.time_embed(delta_t).unsqueeze(1)
    ...
    def forward_decoder(self, x, x_future, ids_restore, delta_t, return_reg=False):
        ...
        # add time embeddings to x
        x = x + self.decoder_time_embed(delta_t).unsqueeze(1)
...
def dep_siam_mae3d_vit_base_patch16_dec384d8b(patch_size=(16,16,8), **kwargs):
    model = dep_SiamMaskedAutoencoderViT3D(
...
dep_siam_mae3d_vit_base_patch16 = dep_siam_mae3d_vit_base_patch16_dec384d8b  # decoder: 384 dim, 8 blocks
