...
class le_dep_cond_ablation(nn.Module):
    ...
    def __init__(self, img_size=(224,224,32), patch_size=(16,16,16), in_chans=3,
        ...
        self.decoder_time_embed = TimestepEmbedder(decoder_embed_dim, 64, 160) # This is added to Q in the decoder #TODO not used for now
    ...
    def forward_prior(self, imgs, delta_t):
        ...
        prior_h = h[:, 0] + self.encoder_time_embed(delta_t).unsqueeze(1)  # Use CLS tokens + time embedding
...
def le_dep_cond_ablation_mae3d_vit_base_patch16_dec384d8b(patch_size=(16,16,8), **kwargs):
    model = le_dep_cond_ablation(
...
le_dep_cond_ablation_mae3d_vit_base_patch16 = le_dep_cond_ablation_mae3d_vit_base_patch16_dec384d8b  # decoder: 384 dim, 8 blocks