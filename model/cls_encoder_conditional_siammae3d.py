...
class cls_ce_SiamMaskedAutoencoderViT3D(nn.Module):
...
def cls_ce_siam_mae3d_vit_base_patch16_dec384d8b(patch_size=(16,16,8), **kwargs):
    model = cls_ce_SiamMaskedAutoencoderViT3D(
...
cls_ce_siam_mae3d_vit_base_patch16 = cls_ce_siam_mae3d_vit_base_patch16_dec384d8b  # decoder: 384 dim, 8 blocks
